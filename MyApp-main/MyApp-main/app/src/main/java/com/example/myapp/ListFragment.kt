...
class ListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val allItems: List<Any> = itemsViewModel.getAll().values.flatMap { it }
        val arrayAdapter = ArrayAdapter(requireContext(), android.R.layout.simple_list_item_1, allItems)
